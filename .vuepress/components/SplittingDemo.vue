<template>
  <!-- splitting.js demo 案例 -->
  <div class="splitting-deom">
    <h1
      class="plop-it"
      data-splitting
    >Plop Effect</h1>
    ...
    <h1
      ...
      data-splitting
    >Horizontal Slide Effect</h1>

    <h1
      class="slide-vertical"
      data-splitting
    >Vertical Slide Effect</h1>
...
// } */
  ...
  .pinch-it:hover .char {
    transform: translateX(calc(-1em * var(--distance-sine)))
